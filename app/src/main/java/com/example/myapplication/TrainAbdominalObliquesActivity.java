...
public class TrainAbdominalObliquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tain_abdominal_obliques);
        ...
        String dfaifd = new String("a=腹斜筋");//androidstudioからphpに値を送る文字列(phpにはaと設定しているためa=XXXとする)
    ...
    public void onClick1(View v) {
        Intent intent = new Intent(this,TrainAbdominalobliquesDescriptionActivity.class);
