...
public class AWSconnectTempo extends AsyncTask<String, Void, String> {
    ...
    public AWSconnectTempo(TextView textView1 , TextView textView2 , TextView textView3 , TextView textView4, TextView textView5) {//textviewを設定する。複数をしたいなら複数分引数などの設定をして
        super();
