...
public class TrainButtocksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_buttocks);
    ...
    public void onClick1(View v) {
        Intent intent = new Intent(this,TrainButtocsDiscriptionActivity.class);
