...
public class TrainPectoralisMajorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_pectoralis_major);
        ...
        String dfaifd = new String("a=大胸筋");//androidstudioからphpに値を送る文字列(phpにはaと設定しているためa=XXXとする)
    ...
    public void onClick1(View v) {
        Intent intent = new Intent(this,TrainPectoralisMajorDescriptionActivity.class);
