...
public class TimerSetCountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textview2 = (TextView) this.findViewById(R.id.interval); //このアクティビティ内で受け取るBOX
    ...
    public void onClick1(View v) {
        CountDownTimer countDownTimer = new CountDownTimer(Miniute, 1000) {    //回数
            ...
            TextView IntervalMiniute = (TextView) findViewById(R.id.interval);//インターバル分
            ...
            public void onFinish() {
                if (set == 0 && numbertime == 0) {
                    Intent intent = new Intent(TimerSetCountActivity.this, MenuActivity.class);
