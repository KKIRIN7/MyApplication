...
public class TrainLatissimusdorsiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_latissimusdorsi);
        ...
        String dfaifd = new String("a=広背筋");//androidstudioからphpに値を送る文字列(phpにはaと設定しているためa=XXXとする)
    ...
    public void onClick1(View v) {
        Intent intent = new Intent(this,TrainLatissimusdorsiDescriptionActivity.class);
